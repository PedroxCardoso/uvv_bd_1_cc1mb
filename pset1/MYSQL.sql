...
-- Criação da tabela funcionários, onde CPF é PK.
...
-- criação da tabela departamento, onde departamento é PK.
...
-- criação da tabela projeot, onde primary key é numero_projeto.
...
-- criar tabela "trabalha_em", onde PK é cpf_funcionario e numero_projeto.
...
-- criação da tabela localizacoes_departamento, onde PK numero_departamento, local.
...
-- criacao da tabela dependentes, PK cpf_funcionario e nome_dependente.
...
-- essa seção preenche as tabelas com os valores 

INSERT INTO funcionarios(cpf, primeiro_nome, nome_meio, ultimo_nome, data_nascimento, endereco, sexo, salario, cpf_supervisor, numero_departamento)
